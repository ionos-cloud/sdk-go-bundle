...
func (r ApiClusterBackupsGetRequest) Execute() (ClusterBackupList, *common.APIResponse, error) {
 ...
 */
func (a *BackupsApiService) ClusterBackupsGetExecute(r ApiClusterBackupsGetRequest) (ClusterBackupList, *common.APIResponse, error) {
	var (
...
func (r ApiClustersBackupsFindByIdRequest) Execute() (BackupResponse, *common.APIResponse, error) {
 ...
 */
func (a *BackupsApiService) ClustersBackupsFindByIdExecute(r ApiClustersBackupsFindByIdRequest) (BackupResponse, *common.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiClustersBackupsGetRequest) Execute() (ClusterBackupList, *common.APIResponse, error) {
 ...
 * @return ClusterBackupList
 */
func (a *BackupsApiService) ClustersBackupsGetExecute(r ApiClustersBackupsGetRequest) (ClusterBackupList, *common.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
