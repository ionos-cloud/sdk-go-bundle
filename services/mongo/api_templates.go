...
func (r ApiTemplatesGetRequest) Execute() (TemplateList, *common.APIResponse, error) {
 ...
 * @return TemplateList
 */
func (a *TemplatesApiService) TemplatesGetExecute(r ApiTemplatesGetRequest) (TemplateList, *common.APIResponse, error) {
	var (
