...
// checks if the NodePoolResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NodePoolResponseData{}
...
func NewNullableNodePoolResponseData(val *NodePoolResponseData) *NullableNodePoolResponseData {
	return &NullableNodePoolResponseData{value: val, isSet: true}
}
