...
// checks if the PatchNodePoolProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &PatchNodePoolProperties{}
...
func (o PatchNodePoolProperties) ToMap() (map[string]interface{}, error) {
