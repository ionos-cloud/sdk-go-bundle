...
// checks if the ClusterListResponseData type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClusterListResponseData{}
...
func (o ClusterListResponseData) ToMap() (map[string]interface{}, error) {
...
func NewNullableClusterListResponseData(val *ClusterListResponseData) *NullableClusterListResponseData {
	return &NullableClusterListResponseData{value: val, isSet: true}
}
