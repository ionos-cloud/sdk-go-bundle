...
const (
	...
	Version               = "products/cert/v2.2.1"
	DefaultIonosServerUrl = "https://certificate-manager.de-fra.ionos.com"
	DefaultIonosBasePath  = ""
)

// APIClient manages communication with the Certificate Manager Service API API v2.0
...
func NewAPIClient(cfg *shared.Configuration) *APIClient {
	...
	*cfgCopy = *cfg
	...
	if cfgCopy.UserAgent == "" {
		cfgCopy.UserAgent = "sdk-go-bundle/products/cert/v2.2.1"
	}
	...
	if len(cfgCopy.Servers) == 0 {
		cfgCopy.Servers = shared.ServerConfigurations{
			{
				URL:         "https://certificate-manager.de-fra.ionos.com",
	...
	// API Services
	c.AutoCertificateApi = (*AutoCertificateApiService)(&c.common)
