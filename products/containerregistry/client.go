...
const (
	...
	Version               = "products/containerregistry/v2.1.1"
	DefaultIonosServerUrl = "https://api.ionos.com/containerregistries"
	DefaultIonosBasePath  = "/containerregistries"
)

// APIClient manages communication with the Container Registry service API v1.2.1
...
func NewAPIClient(cfg *shared.Configuration) *APIClient {
	...
	*cfgCopy = *cfg
	...
	if cfgCopy.UserAgent == "" {
		cfgCopy.UserAgent = "sdk-go-bundle/products/containerregistry/v2.1.1"
	}
