...
const (
	...
	Version               = "products/vmautoscaling/v2.0.2"
...
func NewAPIClient(cfg *shared.Configuration) *APIClient {
	...
	*cfgCopy = *cfg
	...
	if cfgCopy.UserAgent == "" {
		cfgCopy.UserAgent = "sdk-go-bundle/products/vmautoscaling/v2.0.2"
	}
	...
	// API Services
	c.AutoScalingGroupsApi = (*AutoScalingGroupsApiService)(&c.common)
