...
func (r ApiClustersRestorePostRequest) Execute() (*common.APIResponse, error) {
 ...
 */
func (a *RestoresApiService) ClustersRestorePostExecute(r ApiClustersRestorePostRequest) (*common.APIResponse, error) {
	var (
