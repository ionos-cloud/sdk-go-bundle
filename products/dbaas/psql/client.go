...
type APIClient struct {
	...
	BackupLocationsApi *BackupLocationsApiService
	...
	*cfgCopy = *cfg
	...
	if len(cfgCopy.Servers) == 0 {
		cfgCopy.Servers = shared.ServerConfigurations{
			{
				URL:         "https://postgresql.de-txl.ionos.com",
				Description: "Germany, Berlin",
			},
			{
				URL:         "https://postgresql.de-fra.ionos.com",
				Description: "Germany, Frankfurt (de/fra, de/fra/2)",
			},
			{
				URL:         "https://postgresql.fr-par.ionos.com",
				Description: "France, Paris",
			},
			{
				URL:         "https://postgresql.es-vit.ionos.com",
				Description: "Spain, Logroño",
			},
			{
				URL:         "https://postgresql.gb-lhr.ionos.com",
				Description: "United Kingdom, London",
			},
			{
				URL:         "https://postgresql.gb-bhx.ionos.com",
				Description: "United Kingdom, Worcester",
			},
			{
				URL:         "https://postgresql.us-las.ionos.com",
				Description: "United States, Las Vegas",
			},
			{
				URL:         "https://postgresql.us-mci.ionos.com",
				Description: "United States, Lenexa",
			},
			{
				URL:         "https://postgresql.us-ewr.ionos.com",
				Description: "United States, Newark",
			},
		}
	} else {
	...
	// API Services
	c.BackupLocationsApi = (*BackupLocationsApiService)(&c.common)
