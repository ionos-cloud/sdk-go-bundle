...
func (r ApiClusterLogsGetRequest) Execute() (ClusterLogs, *common.APIResponse, error) {
 ...
 * @return ClusterLogs
 */
func (a *LogsApiService) ClusterLogsGetExecute(r ApiClusterLogsGetRequest) (ClusterLogs, *common.APIResponse, error) {
	var (
