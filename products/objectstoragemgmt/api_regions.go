...
func (r ApiRegionsFindByRegionRequest) Execute() (RegionRead, *shared.APIResponse, error) {
 ...
 * @return RegionRead
 */
func (a *RegionsApiService) RegionsFindByRegionExecute(r ApiRegionsFindByRegionRequest) (RegionRead, *shared.APIResponse, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"region"+"}", _neturl.PathEscape(parameterValueToString(r.region, "")), -1)
...
func (r ApiRegionsGetRequest) Execute() (RegionReadList, *shared.APIResponse, error) {
 ...
 */
func (a *RegionsApiService) RegionsGetExecute(r ApiRegionsGetRequest) (RegionReadList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
