...
func (r ApiClustersTopicsDeleteRequest) Execute() (*shared.APIResponse, error) {
 ...
 */
func (a *TopicsApiService) ClustersTopicsDeleteExecute(r ApiClustersTopicsDeleteRequest) (*shared.APIResponse, error) {
	var (
	...
	localVarPath = strings.Replace(localVarPath, "{"+"topicId"+"}", _neturl.PathEscape(parameterValueToString(r.topicId, "")), -1)
...
func (r ApiClustersTopicsFindByIdRequest) Execute() (TopicRead, *shared.APIResponse, error) {
 ...
 * @return TopicRead
 */
func (a *TopicsApiService) ClustersTopicsFindByIdExecute(r ApiClustersTopicsFindByIdRequest) (TopicRead, *shared.APIResponse, error) {
	var (
...
func (r ApiClustersTopicsGetRequest) Execute() (TopicReadList, *shared.APIResponse, error) {
 ...
 */
func (a *TopicsApiService) ClustersTopicsGetExecute(r ApiClustersTopicsGetRequest) (TopicReadList, *shared.APIResponse, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		localVarFormFileName string
...
func (r ApiClustersTopicsPostRequest) Execute() (TopicRead, *shared.APIResponse, error) {
 ...
 * @return TopicRead
 */
func (a *TopicsApiService) ClustersTopicsPostExecute(r ApiClustersTopicsPostRequest) (TopicRead, *shared.APIResponse, error) {
	var (
