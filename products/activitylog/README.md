...
```bash
go get github.com/ionos-cloud/sdk-go-bundle/products/activitylog.git
```
To update the SDK use go get -u to retrieve the latest version of the SDK.
```bash
go get -u github.com/ionos-cloud/sdk-go-bundle/products/activitylog.git
```
### Go Modules
...
```bash
go get github.com/ionos-cloud/sdk-go-bundle/products/activitylog@latest
```
...
- *https://api.ionos.com* - No description provided

By default, *https://api.ionos.com* is used, however this can be overriden at authentication, either
...
func basicAuthExample() error {
	...
	cfg.LogLevel = Trace
	apiClient := activitylog.NewAPIClient(cfg)
	return nil
}
```
...
------------- | ------------- | ------------- | -------------
ContractsApi | [**GetAvailableContracts**](docs/api/ContractsApi.md#getavailablecontracts) | **Get** /activitylog/v1/contracts | List all accessible contracts
ContractsApi | [**GetByContract**](docs/api/ContractsApi.md#getbycontract) | **Get** /activitylog/v1/contracts/{contractNumber} | Download Activity Log entries.
InfoApi | [**GetInfo**](docs/api/InfoApi.md#getinfo) | **Get** /activitylog/v1 | Display API information
...
<summary title="Click to toggle">API models list</summary>
 ...
 - [GetByContractResponse](docs/models/GetByContractResponse)
 - [GetByContractResponseHits](docs/models/GetByContractResponseHits)
 - [GetByContractResponseHitsHits](docs/models/GetByContractResponseHitsHits)
 - [GetByContractResponseHitsHitsSource](docs/models/GetByContractResponseHitsHitsSource)
 - [GetByContractResponseHitsHitsSourceEvent](docs/models/GetByContractResponseHitsHitsSourceEvent)
 - [GetByContractResponseHitsHitsSourceEventParam](docs/models/GetByContractResponseHitsHitsSourceEventParam)
 - [GetByContractResponseHitsHitsSourceEventParamError](docs/models/GetByContractResponseHitsHitsSourceEventParamError)
 - [GetByContractResponseHitsHitsSourceEventParamErrorMessages](docs/models/GetByContractResponseHitsHitsSourceEventParamErrorMessages)
 - [GetByContractResponseHitsHitsSourceEventResources](docs/models/GetByContractResponseHitsHitsSourceEventResources)
 - [GetByContractResponseHitsHitsSourceMeta](docs/models/GetByContractResponseHitsHitsSourceMeta)
 - [GetByContractResponseHitsHitsSourcePrincipal](docs/models/GetByContractResponseHitsHitsSourcePrincipal)
 - [GetByContractResponseHitsHitsSourcePrincipalIdentity](docs/models/GetByContractResponseHitsHitsSourcePrincipalIdentity)
 - [Info](docs/models/Info)
 - [ReferenceById](docs/models/ReferenceById)
