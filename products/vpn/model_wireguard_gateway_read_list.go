...
// checks if the WireguardGatewayReadList type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WireguardGatewayReadList{}
...
type NullableWireguardGatewayReadList struct {
	value *WireguardGatewayReadList
	isSet bool
}

func (v NullableWireguardGatewayReadList) Get() *WireguardGatewayReadList {
	return v.value
}

func (v *NullableWireguardGatewayReadList) Set(val *WireguardGatewayReadList) {
	v.value = val
	v.isSet = true
}

func (v NullableWireguardGatewayReadList) IsSet() bool {
	return v.isSet
}

func (v *NullableWireguardGatewayReadList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWireguardGatewayReadList(val *WireguardGatewayReadList) *NullableWireguardGatewayReadList {
	return &NullableWireguardGatewayReadList{value: val, isSet: true}
}
