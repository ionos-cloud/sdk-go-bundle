...
const (
	...
	Version               = "products/vpn/v2.0.4"
	DefaultIonosServerUrl = "https://vpn.de-fra.ionos.com"
...
func NewAPIClient(cfg *shared.Configuration) *APIClient {
	...
	*cfgCopy = *cfg
	...
	if cfgCopy.UserAgent == "" {
		cfgCopy.UserAgent = "sdk-go-bundle/products/vpn/v2.0.4"
	}
	...
	if len(cfgCopy.Servers) == 0 {
		cfgCopy.Servers = shared.ServerConfigurations{
			{
				URL:         "https://vpn.de-fra.ionos.com",
				Description: "Production de-fra",
			},
			{
				URL:         "https://vpn.de-txl.ionos.com",
			...
			{
				URL:         "https://vpn.us-ewr.ionos.com",
				Description: "Production us-ewr",
			},
			{
				URL:         "https://vpn.us-las.ionos.com",
				Description: "Production us-las",
			},
			{
				URL:         "https://vpn.us-mci.ionos.com",
				Description: "Production us-mci",
			},
			{
				URL:         "https://vpn.fr-par.ionos.com",
	...
	// API Services
	c.IPSecGatewaysApi = (*IPSecGatewaysApiService)(&c.common)
	c.IPSecTunnelsApi = (*IPSecTunnelsApiService)(&c.common)
	c.WireguardGatewaysApi = (*WireguardGatewaysApiService)(&c.common)
	c.WireguardPeersApi = (*WireguardPeersApiService)(&c.common)
