...
// APIClient manages communication with the IONOS Object Storage API for user-owned buckets API v2.0.15
...
func NewAPIClient(cfg *shared.Configuration) *APIClient {
	...
	if len(cfgCopy.Servers) == 0 {
		cfgCopy.Servers = shared.ServerConfigurations{
			{
				URL:         "https://s3.eu-central-1.ionoscloud.com",
				Description: "URL for `de` (Frankfurt, Germany)",
			},
			{
				URL:         "https://s3.de-central.profitbricks.com",
				Description: "Legacy URL for `de` (Frankfurt, Germany)",
			},
			{
				URL:         "https://s3.eu-central-2.ionoscloud.com",
				Description: "URL for `eu-central-2` (Berlin, Germany)",
			},
			{
				URL:         "https://s3.eu-south-2.ionoscloud.com",
