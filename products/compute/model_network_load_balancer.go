...
// checks if the NetworkLoadBalancer type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NetworkLoadBalancer{}
...
func (o *NetworkLoadBalancer) GetEntities() NetworkLoadBalancerEntities {
	if o == nil || IsNil(o.Entities) {
		var ret NetworkLoadBalancerEntities
		return ret
	}
	return *o.Entities
}
...
// SetEntities gets a reference to the given NetworkLoadBalancerEntities and assigns it to the Entities field.
