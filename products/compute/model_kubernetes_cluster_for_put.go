...
// checks if the KubernetesClusterForPut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesClusterForPut{}
...
func (o *KubernetesClusterForPut) GetProperties() KubernetesClusterPropertiesForPut {
	if o == nil {
		var ret KubernetesClusterPropertiesForPut
		return ret
	}
...
func (o KubernetesClusterForPut) ToMap() (map[string]interface{}, error) {
