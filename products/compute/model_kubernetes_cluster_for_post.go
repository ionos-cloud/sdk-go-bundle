...
// checks if the KubernetesClusterForPost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &KubernetesClusterForPost{}
...
func (o *KubernetesClusterForPost) GetProperties() KubernetesClusterPropertiesForPost {
	if o == nil {
		var ret KubernetesClusterPropertiesForPost
		return ret
	}
...
func (o KubernetesClusterForPost) ToMap() (map[string]interface{}, error) {
