...
const (
	...
	Version = "products/compute/v0.1.3.test"
)
...
func (c *APIClient) GetRequestStatus(ctx context.Context, path string) (*RequestStatus, *common.APIResponse, error) {
...
type resourceDeleteCallFn func(apiClient *APIClient, resourceID string) (*common.APIResponse, error)
...
func (c *APIClient) WaitForRequest(ctx context.Context, path string) (*common.APIResponse, error) {
