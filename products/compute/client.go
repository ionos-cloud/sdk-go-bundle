...
const (
	...
	Version = "products/compute/v2.0.0"
)
...
func (c *APIClient) prepareRequest(
	...
	val, isSetInEnv := os.LookupEnv("IONOS_CONTRACT_NUMBER")
...
func (c *APIClient) GetRequestStatus(ctx context.Context, path string) (*RequestStatus, *shared.APIResponse, error) {
...
type resourceDeleteCallFn func(apiClient *APIClient, resourceID string) (*shared.APIResponse, error)
...
func (c *APIClient) WaitForRequest(ctx context.Context, path string) (*shared.APIResponse, error) {
