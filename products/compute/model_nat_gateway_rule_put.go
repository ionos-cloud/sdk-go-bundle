...
// checks if the NatGatewayRulePut type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &NatGatewayRulePut{}
...
func (o NatGatewayRulePut) ToMap() (map[string]interface{}, error) {
